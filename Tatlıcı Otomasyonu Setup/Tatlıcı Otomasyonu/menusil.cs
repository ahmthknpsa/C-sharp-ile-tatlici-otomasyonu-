...
namespace Tatlıcı_Otomasyonu
{
    public partial class menusil : Form
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            while(oku.Read())
            {
                textBox2.Text = oku["fiyati"].ToString();
        ...
        {
            baglanti.Open();
            OleDbCommand komut = new OleDbCommand(" delete from menu where barkodno = '" + textBox1.Text + "'", baglanti);
            komut.ExecuteNonQuery();    // insert, update , delete işlemlerinde satırları döndürüyor 
            baglanti.Close();
